...
#these t tests show that there is a potential relation between the lower 40% of BMI values are only prediabetic at most while the top 40% of BMI values still suggests prediabetes, but much closer to the cutoff for diabetes (126 mg/dL) -> could suggest these patients need closer monitoring
